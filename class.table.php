<?php 
 /**
     * HTML  TABLE design pattern - Generates all HTML TABLE elements
     *
     * <p>This class contains the methods for generating Tables snd related elements so we do not
...
class HTML_Table { 
/**
* Class to implement an HTML TABLE design pattern    
*      
* @package HTML_Table
*/
    private $rows = array(); 
